      ...
      <div className="space-y-4 mt-6">
        <div className="cyber-panel p-3">
          <div className="flex justify-between items-center">
            ...
            <div className="text-sm font-bold hover:scale-110 hover:text-cyber-green transition-all">
              {userLevel}
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="cyber-panel p-2 hover:scale-105 transition-all">
        ...
        <div className="flex-1 flex flex-col h-full overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-6">
            ...
            <div className="space-y-6 pb-4">
              ...
              {isTyping && (
                <div 
                  className="flex items-center space-x-2 text-gray-400 animate-fade-in"
                >
